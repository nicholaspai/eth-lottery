...
var _StatusReport = require('./StatusReport');

var _StatusReport2 = _interopRequireDefault(_StatusReport);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const log = new _zosLib.Logger('StatusComparator');
...
class StatusComparator {
  ...
  _addReport(expected, observed, description) {
    const report = new _StatusReport2.default(expected, observed, description);
